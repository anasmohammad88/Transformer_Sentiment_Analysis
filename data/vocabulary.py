...
class Vocabulary:
    def __init__(self, vocab_size=20000, min_frequency=1):
        ...
        self.CLS_TOKEN = "<CLS>"
        self.SEP_TOKEN = "<SEP>"
        self.word_to_index = {self.PAD_TOKEN: 0, self.UNK_TOKEN: 1, self.CLS_TOKEN: 2, self.SEP_TOKEN:3}
        self.index_to_word = {0: self.PAD_TOKEN, 1: self.UNK_TOKEN, 2:self.CLS_TOKEN, 3: self.SEP_TOKEN}
